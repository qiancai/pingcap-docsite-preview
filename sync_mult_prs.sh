...
#./sync_pr.sh preview/pingcap/docs-cn/21195
#./sync_pr.sh preview/pingcap/docs/22190
./sync_pr.sh preview-cloud/pingcap/docs/21849
#./sync_pr.sh preview-cloud/pingcap/docs/21964
