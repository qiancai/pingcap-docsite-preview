...
- Before you create an endpoint, make sure the following:
    ...
    - You have created a TiDB Cloud Starter instance and a Data App. For more information, see [Create a Data App](/tidb-cloud/data-service-manage-data-app.md#create-a-data-app).
    - The databases, tables, and columns that the endpoint will operate on already exist in the target TiDB Cloud Starter instance.
...
3. In the dialog, do the following:
    ...
    1. Select the target TiDB Cloud Starter instance, database, and table for the endpoint to be generated.
...
For each endpoint, you can write SQL statements to execute on a TiDB Cloud Starter instance, define parameters for the SQL statements, or manage the name and version.
...
1. Select a TiDB Cloud Starter instance.
    ...
    > **Note:**
    >
    > Only TiDB Cloud Starter instances that are linked to the Data App are displayed in the drop-down list. To manage the linked TiDB Cloud Starter instances, see [Manage linked data source](/tidb-cloud/data-service-manage-data-app.md#manage-linked-data-sources).
