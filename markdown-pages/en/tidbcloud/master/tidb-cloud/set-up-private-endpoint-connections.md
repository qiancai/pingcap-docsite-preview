...
> **Tip:**
>
> - To learn how to connect to a TiDB Cloud Starter cluster via AWS PrivateLink, see [Connect to TiDB Cloud Starter via AWS PrivateLink](/tidb-cloud/set-up-private-endpoint-connections-serverless.md).
