...
If you need to configure these external storages for TiDB Cloud Starter or TiDB Cloud Essential instances, see [Configure External Storage Access for TiDB Cloud Starter or Essential](/tidb-cloud/configure-external-storage-access.md).
