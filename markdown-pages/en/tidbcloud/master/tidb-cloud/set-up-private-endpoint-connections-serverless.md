...
This document describes how to connect to your TiDB Cloud Starter or TiDB Cloud Essential cluster via AWS PrivateLink.
...
To connect to your TiDB Cloud Starter or TiDB Cloud Essential cluster via a private endpoint, follow these steps:
...
4. Take a note of **Service Name**, **Availability Zone ID**, and **Region ID**.
    ...
    > **Note:**
    >
    > You only need to create one private endpoint per AWS region, which can be shared by all TiDB Cloud Starter or TiDB Cloud Essential clusters located in the same region.
