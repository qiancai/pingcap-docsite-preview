...
The audit logging feature is **disabled by default**. To audit a TiDB Cloud Essential instance, you need to enable audit logging for it.
...
You can enable audit logging for a TiDB Cloud Essential instance using the TiDB Cloud console or the TiDB Cloud CLI.
...
2. Click the name of your target TiDB Cloud Essential instance to go to its overview page, and then click **Settings** > **DB Audit Logging** in the left navigation pane.
...
You can edit the audit logging for a TiDB Cloud Essential instance after enabling it.
...
You can disable audit logging for a TiDB Cloud Essential instance.
...
| `SERVERLESS_TENANT_ID`           | The ID of the serverless tenant that the TiDB Cloud Essential instance belongs to.                 |
| `SERVERLESS_PROJECT_ID`          | The ID of the serverless project that the TiDB Cloud Essential instance belongs to.                |
| `SERVERLESS_CLUSTER_ID`          | The ID of the serverless TiDB Cloud Essential instance that the audit record belongs to.           |
