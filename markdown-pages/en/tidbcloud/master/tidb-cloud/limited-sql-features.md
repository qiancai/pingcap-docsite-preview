...
| Statement | TiDB Cloud Dedicated | TiDB Cloud Starter and TiDB Cloud Essential |
|:-|:-|:-|
...
| `ADMIN RESET TELEMETRY_ID` | Supported | Telemetry is not supported on TiDB Cloud Starter or TiDB Cloud Essential. |
...
| `ALTER INSTANCE RELOAD TLS` | Supported | TiDB Cloud Starter and TiDB Cloud Essential automatically refresh the TLS certificate. |
...
| Function and operator | TiDB Cloud Dedicated | TiDB Cloud Starter and TiDB Cloud Essential |
|:-|:-|:-|
...
| Database | Table | TiDB Cloud Dedicated | TiDB Cloud Starter and TiDB Cloud Essential |
|:-|:-|:-|:-|
...
| Variable | TiDB Cloud Dedicated | TiDB Cloud Starter and TiDB Cloud Essential |
|:-|:-|:-|
...
[^1]: Configuring data placement is not supported on TiDB Cloud Starter or TiDB Cloud Essential.

[^2]: Configuring resource groups is not supported on TiDB Cloud Starter or TiDB Cloud Essential.

[^3]: To perform [Back up and Restore](/tidb-cloud/backup-and-restore-serverless.md) operations on TiDB Cloud Starter or TiDB Cloud Essential, you can use the TiDB Cloud console instead.

[^4]: The feature is unavailable in [Security Enhanced Mode (SEM)](/system-variables.md#tidb_enable_enhanced_security).

[^5]: To track [Slow Query](/tidb-cloud/tune-performance.md#slow-query) on TiDB Cloud Starter or TiDB Cloud Essential, you can use the TiDB Cloud console instead.

[^6]: To perform [Statement Analysis](/tidb-cloud/tune-performance.md#statement-analysis) on TiDB Cloud Starter or TiDB Cloud Essential, you can use the TiDB Cloud console instead.

[^7]: Drainer and Pump are not supported on TiDB Cloud.

[^8]: Plugin is not supported on TiDB Cloud Starter or TiDB Cloud Essential.

[^9]: TiDB Cloud Starter and TiDB Cloud Essential enforce strong password policy.

[^10]: The variable is read-only on TiDB Cloud Starter and TiDB Cloud Essential.

[^11]: TiDB Cloud Starter and TiDB Cloud Essential do not support downloading the file exported by `PLAN REPLAYER` through `${tidb-server-status-port}` as in the [example](https://docs.pingcap.com/tidb/stable/sql-plan-replayer#examples-of-exporting-cluster-information). Instead, TiDB Cloud Starter and TiDB Cloud Essential generate a [presigned URL](https://docs.aws.amazon.com/AmazonS3/latest/userguide/ShareObjectPreSignedURL.html) for you to download the file. Note that this URL remains valid for 10 hours after generation.
