...
6. Update the capacity of the instance.
    ...
    - **Starter** plan:
        ...
        - By default, each organization can create up to five [free TiDB Cloud Starter instances](/tidb-cloud/select-cluster-tier.md#starter). To create additional TiDB Cloud Starter instances, you must add a credit card and specify a spending limit.
