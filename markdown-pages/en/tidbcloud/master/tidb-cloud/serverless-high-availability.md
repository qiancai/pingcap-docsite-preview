...
> **Note:**
>
> - This document is only applicable for TiDB Cloud Starter, TiDB Cloud Essential, and TiDB Cloud Premium.
...
> **Note:**
> 
> - For TiDB Cloud Starter and Essential instances, only zonal high availability is enabled, and it is not configurable. 
> - For TiDB Cloud Premium instances, only regional high availability is enabled and is not configurable.
...
> **Note:**
>
> - For TiDB Cloud Starter instances, only zonal high availability is enabled, and it is not configurable.
> - For TiDB Cloud Premium instances, only regional high availability is enabled and is not configurable.
> - For TiDB Cloud Essential instances hosted in the AWS Tokyo (ap-northeast-1) region, regional high availability is enabled by default. You can change it to zonal high availability as needed during TiDB Cloud Essential instance creation. For TiDB Cloud Essential instances hosted in other regions, only zonal high availability is enabled, and it is not configurable.
