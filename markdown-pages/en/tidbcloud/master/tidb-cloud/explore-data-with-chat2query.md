...
- SQL Editor is available only for [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#starter) instances hosted on AWS. To use SQL Editor and Chat2Query on [TiDB Cloud Dedicated](/tidb-cloud/select-cluster-tier.md#tidb-cloud-dedicated) clusters, contact [TiDB Cloud support](/tidb-cloud/tidb-cloud-support.md).
...
2. Click the name of your TiDB Cloud Starter instance or TiDB Cloud Dedicated cluster, and then click **SQL Editor** in the left navigation pane.
