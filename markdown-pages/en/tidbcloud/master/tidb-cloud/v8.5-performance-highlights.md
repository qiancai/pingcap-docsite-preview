...
<table>
    <thead>
        <tr>
            <th rowspan="2">Workload:<br/>Simulated Workload</th>
            <th colspan="3">With IO latency jitter improvement</th>
            <th colspan="3">Without IO latency jitter improvement</th>
        </tr>
        <tr>
            <th>Failover time</th>
            <th>Max drop rate of QPS during failover</th>
            <th>Max latency (P999/P99) during failover</th>
            <th>Failover time</th>
            <th>Max drop rate of QPS during failover</th>
            <th>Max latency (P999/P99) during failover</th>
        </tr>
    ...
    <tbody>
        <tr>
            <td>IO delay 2ms lasts for 10mins</td>
            <td>Almost no effect</td>
            <td>1%</td>
            <td>14ms/7.9ms</td>
            <td>Cannot failover</td>
            <td>38%</td>
            <td>232ms/22.9ms</td>
        </tr>
        <tr>
            <td>IO delay 5ms lasts for 10mins</td>
            <td>2 mins</td>
            <td>29%</td>
            <td>37.9ms/10ms</td>
            <td>Cannot failover</td>
        ...
        <tr>
            <td>IO delay 10ms lasts for 10mins</td>
            <td>3 mins</td>
            <td>18%</td>
            <td>69ms/25ms</td>
            <td>Cannot failover</td>
        ...
        <tr>
            <td>IO delay 50ms lasts for 10mins</td>
            <td>3 mins</td>
            <td>53%</td>
            <td>1.36s/238ms</td>
            <td>Cannot failover</td>
        ...
        <tr>
            <td>IO delay 100ms lasts for 10mins</td>
            <td>3 mins</td>
            <td>80%</td>
            <td>7.53s/1.7s</td>
            <td>Cannot failover</td>
        ...
        <tr>
            <td>IO delay 500ms lasts for 10mins</td>
            <td>2 mins</td>
            <td>92%</td>
            <td>7.22s/894ms</td>
            <td>4 mins</td>
        ...
        <tr>
            <td>IO delay 1s lasts for 10mins</td>
            <td>3 mins</td>
            <td>93%</td>
            <td>4.66s/929ms</td>
            <td>4 mins</td>
