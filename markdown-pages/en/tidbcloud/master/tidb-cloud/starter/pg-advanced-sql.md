...
PostgreSQL-compatible TiDB Cloud Starter supports common advanced PostgreSQL features, including PL/pgSQL functions, triggers, sequences, enum and composite types, and custom collations.
