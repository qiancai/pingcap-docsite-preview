...
3. To create a new PostgreSQL-compatible TiDB Cloud Starter instance, follow these steps:
    ...
    >
    > The first 10 PostgreSQL-compatible TiDB Cloud Starter instances in your account are eligible for the free quota. Each eligible instance includes the following monthly free quota:
    >
