...
PostgreSQL-compatible TiDB Cloud Starter provides `pg_catalog` relations and `information_schema` views for inspecting databases, schemas, tables, columns, indexes, constraints, functions, roles, and other database objects.
