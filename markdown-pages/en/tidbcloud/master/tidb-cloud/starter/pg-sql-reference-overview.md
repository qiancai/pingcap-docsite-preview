...
PostgreSQL-compatible TiDB Cloud Starter supports the PostgreSQL wire protocol and common PostgreSQL syntax. You can use most PostgreSQL clients, drivers, and ORMs to work with your instance.
