...
> **Note:**
>
> The serverless driver is in public preview and only applicable to TiDB Cloud Starter or TiDB Cloud Essential instances.
...
[TiDB Cloud serverless driver (Preview)](https://github.com/tidbcloud/serverless-js) for JavaScript lets you connect to your TiDB Cloud Starter or TiDB Cloud Essential instance over HTTP, which is generally supported by serverless environments. With it, it is now possible to connect to TiDB Cloud Starter or TiDB Cloud Essential instances from edge environments and reduce connection overhead with TCP while keeping the similar development experience of traditional TCP-based MySQL drivers.
...
You can use the serverless driver to query data of a TiDB Cloud Starter or TiDB Cloud Essential instance or perform interactive transactions.

### Query

To query data from a TiDB Cloud Starter or TiDB Cloud Essential instance, you need to create a connection first. Then you can use the connection to execute raw SQL queries. For example:
...
|--------------|----------|---------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `username`   | string   | N/A           | Username of the TiDB Cloud Starter or TiDB Cloud Essential instance.                                                                                                                                                                                                                                                                                                                                     |
| `password`   | string   | N/A           | Password of the TiDB Cloud Starter or TiDB Cloud Essential instance.                                                                                                                                                                                                                                                                                                                                     |
| `host`       | string   | N/A           | Hostname of the TiDB Cloud Starter or TiDB Cloud Essential instance.                                                                                                                                                                                                                                                                                                                                     |
| `database`   | string   | `test`        | Database of the TiDB Cloud Starter or TiDB Cloud Essential instance.                                                                                                                                                                                                                                                                                                                                     |
...
- For TiDB Cloud Starter instances, the pricing follows the [TiDB Cloud Starter pricing](https://www.pingcap.com/tidb-cloud-starter-pricing-details/) model.
- For TiDB Cloud Essential instances, the pricing follows the [TiDB Cloud Essential pricing](https://www.pingcap.com/tidb-cloud-essential-pricing-details/) model.
